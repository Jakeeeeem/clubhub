...
const dbConfig = {
  ...(process.env.DATABASE_URL
    ...
    : {
        ...
        database: (process.env.DB_NAME || "clubhub_dev_db").trim(),
...
const queries = {
  ...
  findUserById:
    "SELECT id, email, first_name, last_name, account_type, org_types, created_at FROM users WHERE id = $1",
  createUser: `
  ...
  // Team queries
  findTeamsByClub:
    "SELECT * FROM teams WHERE club_id = $1 ORDER BY created_at DESC",
  ...
  findPaymentsByPlayer:
    "SELECT * FROM payments WHERE player_id = $1 ORDER BY due_date DESC",
  findPaymentsByClub:
    "SELECT * FROM payments WHERE club_id = $1 ORDER BY due_date DESC",
  createPayment: `
  ...
  // Application queries
  findApplicationsByClub:
    "SELECT * FROM club_applications WHERE club_id = $1 ORDER BY submitted_at DESC",
  findApplicationsByUser:
    "SELECT * FROM club_applications WHERE user_id = $1 ORDER BY submitted_at DESC",
  createApplication: `
