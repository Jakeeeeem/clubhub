    ...
    if (grid) {
      grid.innerHTML = tournaments
        .map((t) => {
          ...
          return `
            <div class="comp-card ${compType}" onclick="viewPlayerTournament('${t.id}')" style="cursor:pointer;position:relative;z-index:10;">
                ...
                <div style="margin-top:1rem;padding-top:0.75rem;border-top:1px solid rgba(255,255,255,0.05);display:flex;justify-content:space-between;align-items:center;">
                    <span style="font-size:0.7rem;color:var(--text-muted);">View bracket & stats</span>
                    <i style="color:var(--primary);font-size:1rem;">→</i>
                </div>
            </div>
          `;
        })
